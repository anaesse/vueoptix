...
const Reviews = () => {
    ...
    return (
        <section className="bg-white w-full ">
            <div className="px-4 sm:px-24 lg:px-28  pt-4 sm:pt-14">
                <h1 className="text-center text-[24px] sm:text-3xl font-semibold text-[#363636] lead-[54px]">REVIEWS</h1>
                <p className="text-[16px] sm:text-[24px] text-center text-[#363636] lead-[36px] py-2">Here’s what our clients have to say about us;</p>
