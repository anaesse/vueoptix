            ...
            <div className="bg-white h-[100vh] w-full lg:w-[80%] Hero-container lg:relative">
                <div className="px-4 sm:px-24 lg:px-28 pt-5 lg:pt-28 ">
                    <div className="w-full  lg:w-[50%] lg:h-[48vh]">
                        ...
                        <h1 className="text-4xl sm:text-3xl lead-[60px] py-2">Experience a better vision and a better life with ease</h1>
                    ...
                    <button type="button" class="text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center text-#FFFDFD mr-3 md:mr-0 bg-gradient-to-t from-[#FF2626] to-[#0A27BF] mb-4 lg:mb-0 ">Get started</button>
                </div>

                <div className="flex justify-center lg:absolute lg:top-0 lg:right-0 lg:translate-x-1/3 lg:translate-y-14 Hero-image">
                <img src="https://res.cloudinary.com/dgts9q1iq/image/upload/v1673205633/VueOptix/optometrist_nxybcb.jpg" alt="people" className="h-48 lg:w-[420px] lg:h-[450px] "/>
                </div>
