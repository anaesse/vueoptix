...
const Hero = () => {
    return (
        <section className="bg-[#5A2047] Hero-session h-[100vh]">
            ...
            <div className="flex justify-center lg:absolute lg:top-0 lg:right-0 lg:translate-x-1/3 lg:translate-y-14 Hero-image h-[48%] sm-[55%] md:h-56 lg:w-[420px] lg:h-[450px] mx-auto">
