    ...
    return (
        <section className="bg-[#5A2047] Hero-session h-[100vh]">
            <div className="bg-white h-[100vh] w-full lg:w-[80%] Hero-container lg:relative">
                ...
                <div className="flex justify-center lg:absolute lg:top-0 lg:right-0 lg:translate-x-1/3 lg:translate-y-14 Hero-image h-full md:h-56 lg:w-[420px] lg:h-[450px] mx-auto">
