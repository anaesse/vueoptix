...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-[#5A2047] border-[#5A2047] h-[120px] px-4 sm:px-24 lg:px-28 py-2.5 flex items-center justify-between  w-full z-20  ">
       ...
       <a href="/" className="flex items-center">
        ...
        <ul
          className={`bg-[#5A2047] md:flex md:items-center md:gap-4 lg:gap-14 md:pb-0 pb-12 absolute md:static  md:z-auto left-0 w-full md:w-auto md:pl-0  NavLinks transition-all duration-500 ease-in ${
        ...
        >
          <li className="md:ml-4 lg:ml-8 text-base font-xl font-medium md:my-0 my-7">
            <NavLink
              ...
              className="block py-2 pl-3 pr-4 text-[#FFFDFD] text-sm font-medium  md:p-0"
            >
              Home
            </NavLink>
          </li>
        ...
        <div>
            ...
            <button data-collapse-toggle="navbar-cta" aria-controls="navbar-cta" aria-expanded="false" type="button" className="text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-3 lg:py-2.5 text-center text-#FFFDFD mr-3 md:mr-0 bg-gradient-to-t from-[#FF2626] to-[#0A27BF]">Get started</button>
        </div>
        </ul>
